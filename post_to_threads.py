...
・ハッシュタグなし
・文と文の間は改行する（1文ごとに改行）
・情景描写・詩的表現は使わない（「香りがふわっと」「光がやわらかく」などNG）
・きれいにまとめようとしない。荒削りでいい
・スマホでぱっと打ったような温度感で書く
・「セラピストっぽい素敵な投稿」を作ろうとしない
・関西出身のセラピストとして、自然な関西弁のニュアンスを入れる（例：〜やな、〜やん、〜へん、おる、めっちゃ など）。でんがな・まんねんなど大げさな関西弁は使わない
・投稿文だけ出力"""
