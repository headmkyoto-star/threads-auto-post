...
# ===== 営業投稿（7時・17時）のメニュー別テンプレート =====
# 毎回4メニューから均等ランダムで1つ選ぶ。価格を書くのはドライヘッドスパのみ。
# opening_a = 7時用の書き出し / opening_b = 17時用の書き出し
PROMO_MENUS = [
    {
        "name": "ドライヘッドスパ",
        "opening_a": """京都にいるよ〜って方🙋‍♀️
祇園でドライヘッドスパいかがですか💆✨
70分コース3,980円🌿""",
        "opening_b": """京都祇園でドライヘッドスパ受けたい方いますか☺️❓
70分3,980円🌿""",
        "naming_rule": "施術名は「ヘッドスパ」ではなく必ず「ドライヘッドスパ」と書く",
        "feel_hint": "頭や目の疲れがスッキリする・眠ってしまうほど気持ちいい",
    },
    {
        "name": "アロマトリートメント",
        "opening_a": """京都にいるよ〜って方🙋‍♀️
祇園でアロマトリートメントいかがですか💆‍♀️✨
いい香りに包まれて全身ゆるみますよ🌿""",
        "opening_b": """京都祇園でアロマトリートメント受けたい方いますか☺️❓
オイルのいい香りに癒されますよ🌿""",
        "naming_rule": "施術名を書く場合は「アロマ」または「アロマトリートメント」と書く",
        "feel_hint": "いい香りに癒される・全身の力が抜けてリラックスできる",
    },
    {
        "name": "小顔矯正コルギ",
        "opening_a": """京都にいるよ〜って方🙋‍♀️
祇園で小顔矯正コルギいかがですか👐✨
お顔のむくみ流してスッキリしますよ🌿""",
        "opening_b": """京都祇園で小顔矯正コルギ気になる方いますか☺️❓
お顔スッキリ軽くなりますよ✨""",
        "naming_rule": "施術名を書く場合は「コルギ」または「小顔矯正コルギ」と書く",
        "feel_hint": "お顔のむくみが取れてスッキリ軽くなる・フェイスラインが変わる",
    },
    {
        "name": "もみほぐし",
        "opening_a": """京都にいるよ〜って方🙋‍♀️
祇園でもみほぐしいかがですか💪✨
肩も腰もしっかりほぐしますよ🌿""",
        "opening_b": """京都祇園でもみほぐし受けたい方いますか☺️❓
肩こりも腰の張りもまとめてほぐしますよ🌿""",
        "naming_rule": "施術名を書く場合は「もみほぐし」と書く",
        "feel_hint": "ガチガチの肩や腰が軽くなる・全身ほぐれてラクになる",
    },
]
# ==========================================================
...
def generate_post():
    ...
    if hour in (7, 17):
        menu = random.choice(PROMO_MENUS)
        opening = menu["opening_a"] if hour == 7 else menu["opening_b"]
        print("PROMO_MENU_CHOSEN:" + menu["name"])
        prompt_text = f"""ヘッドミント京都祇園店のセラピストとして、以下の投稿の続きに追加する一言を書いてください。今回の営業メニューは「{menu["name"]}」です。
...
【追加する一言のルール】
・1文だけ（短く！）
・「{menu["name"]}」を受けに来たくなる・コメントしたくなる問いかけか、背中を押す一言（雰囲気: {menu["feel_hint"]}）
...
・{menu["naming_rule"]}
・料金・価格・金額は書かない（書き出しに価格がある場合も繰り返さない）
・ハッシュタグなし
